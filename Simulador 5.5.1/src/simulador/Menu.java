    ...
    public void Menu() {
        ...
        do { //Ciclo de Accesos al Menú
            ...
            tab1 += "SELECCIONE UNA OPCIÓN:\n\n"
                    + "\n1) Para Agregar o Mostrar  Las ID de las Máquinas...\n"
                    + "\n2) Para Agregar Los Costos de Compra...\n"
                    + "\n3) Para Agregar Los Costos de Produccion...\n"
            ...
            do { //Ciclo de Acceso, para el cierre del Programa
                ...
                if ((opt > 8) || (opt < 1)) { //Condiciones de Acceso al Menú
                    ...
                    switch (opt) { //Lectura de la Opción Escogida para el Acceso al Menú
                        ...
                        case 1: //Digitar o mostrar los ID's de las Máquinas
                        ...
                        case 2: //Digitar el Costo de las Máquinas
                            ...
                            switch (optmost) {
                                ...
                                case 2: //Mostrar los Costos de las Máquinas
                                    JOptionPane.showMessageDialog(null, miSimulacion.llamadaGetCostoDeMaquina1(), "ID de la Máquina #1", JOptionPane.WARNING_MESSAGE);
                                    JOptionPane.showMessageDialog(null, miSimulacion.llamadaGetCostoDeMaquina2(), "ID de la Máquina #2", JOptionPane.WARNING_MESSAGE);
                                    break; // Fin del Caso 2
                            }
