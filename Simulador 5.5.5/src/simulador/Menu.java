...
public class Menu {
    ...
    public void Menu() {
        ...
        miSimulacion.setPrecio(Double.parseDouble(JOptionPane.showInputDialog("Digite el Precio de Venta del Producto que se Creará: ¢")));
        ...
        do { //Ciclo de Accesos al Menú
            ...
            tab1 += "SELECCIONE UNA OPCIÓN:\n\n"
                    ...
                    + "\n8) Para Mostrar un submenu con las opciones de la simulación...\n"
                    + "\n9) SALIDA...\n";
                ...
                if ((opt > 9) || (opt < 1)) { //Condiciones de Acceso al Menú
                    ...
                    switch (opt) { //Lectura de la Opción Escogida para el Acceso al Menú
                        ...
                        case 3: //Digitar el Costo de las Máquinas
                            optmost = Integer.parseInt(JOptionPane.showInputDialog("Digite una Opción:\n" + "1- Cargar los Costos de compra de las máquinas\n" + "2- Mostrar los Costos de compra de las máquinas"));
                        ...
                        case 8:
                            optmost = Integer.parseInt(JOptionPane.showInputDialog("Digite una Opción:\n" + "1- Mostrar la cantidad de productos producidos por las máquinas\n" + "2- Mostrar la ganancia bruta las máquinas\n" + "3- Mostrar la ganancia Neta de las máquinas\n" + "4- Recomendación de cual maquina comprar"));
                            switch (optmost) {
                                case 1:
                                    miSimulacion.simula();
                                    break;
                                case 2:
                                    miSimulacion.gananciaBruta();
                                    break;
                                case 3:
                                    miSimulacion.gananciaNeta();
                                    break;
                                case 4:
        ...
        } while (opt < 10); //Fin del Ciclo de Acceso al Menú
    }
}
